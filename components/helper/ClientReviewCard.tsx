    ...
    <div className="m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg">
      <div className="border-2 p-4 border-gray-700 rounded-xl">
        ...
        <p className="text-[15px] text-white opacity-65 mt-[3rem] text-center">
          I am thrilled with the exceptional service provided! The website
          development exceeded my expectations with its stunning design and
          seamless functionality. The team was professional, responsive, and
          truly understood my vision. I highly recommend their services for any
