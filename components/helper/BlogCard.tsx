...
const BlogCard = ({ image, title, comment, date }: Props) => {
  return (
    <div className="bg-gray-900">
      ...
      <div className="p-4">
        <div
          className="mt-[1rem] mb-[1rem] px-3 py-1 bg-gray-800 w-fit flex items-center
        ...
        <h1
          className="text-[20px] opacity-85 hover:text-yellow-400 transition-all duration-200
        cursor-pointer text-white font-semibold underline"
        >
          {title}
        </h1>
        <div className="flex items-center mt-[2rem] justify-between">
          ...
          <button
            className="text-[15px] hover:text-yellow-500 transition-all duration-150 text-white
