    ...
    <div id="services" className="pt-[5rem] pb-[3rem] bg-[#0b0c13]">
      ...
      >
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <ServiceCard title="Mpesa Integration" num="02" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="400"
        >
          <ServiceCard title="Web Deployment" num="03" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="600"
        >
          <ServiceCard title="School Management System" num="04" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="800"
        >
          <ServiceCard title="Church Management System" num="05" />
        </div>
        <div
          data-aos="fade-up"
          data-aos-anchor-placement="top-center"
          data-aos-delay="1000"
        >
          <ServiceCard title="E-Commerce" num="06" />
        </div>
      </div>
    </div>
  );
